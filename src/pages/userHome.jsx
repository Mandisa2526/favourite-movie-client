...
function UserHome() {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                ...
                // Fetch user profile
                const profileResponse = await fetch('https://favourite-movie-backend.onrender.com/api/users/profile', {
                    headers: {
                ...
                // Fetch favorites
                const favoritesResponse = await fetch('https://favourite-movie-backend.onrender.com/api/users/favorites', {
                    headers: {
                        'Authorization': `Bearer ${token}`
                    }
                });
                ...
                const currentlyWatchingResponse = await fetch('https://favourite-movie-backend.onrender.com/api/users/currently-watching', {
                    headers: {
                        'Authorization': `Bearer ${token}`
                    }
                });
                ...
                // Fetch watch history
                const watchHistoryResponse = await fetch('https://favourite-movie-backend.onrender.com/api/users/watch-history', {
                    headers: {
                        'Authorization': `Bearer ${token}`
                    }
                });
    ...
    const toggleFavorite = async (movie) => {
        try {
            ...
            const endpoint = `https://favourite-movie-backend.onrender.com/api/users/favorites/${movie.id}`;
    ...
    const toggleCurrentlyWatching = async (movie) => {
        try {
            ...
            const endpoint = `https://favourite-movie-backend.onrender.com/api/users/currently-watching/${movie.id}`;
    ...
    const playTrailer = async (movie) => {
        try {
            ...
            if (token) {
                ...
                const response = await fetch(`https://favourite-movie-backend.onrender.com/api/users/recently-watched/${movie.id}`, {
                    method: 'POST',
                    headers: {
                        'Authorization': `Bearer ${token}`
                    }
    ...
    const handleProfileUpdate = async () => {
        try {
            ...
            const response = await fetch('https://favourite-movie-backend.onrender.com/api/users/profile', {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
